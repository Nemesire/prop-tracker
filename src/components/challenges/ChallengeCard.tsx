...
export default function ChallengeCard({ challenge, userProgress }: Props) {
  ...
  return (
    <div className={`bg-[#1A1A2E] border rounded-2xl p-5 transition-all ${completed ? 'border-[#22C55E]/40 bg-[#22C55E]/5' : 'border-[#2D2D4E] hover:border-[#7C3AED]/30'}`}>
      ...
      <h3 className="font-semibold text-[#F8F8FF] mb-1">{challenge.title}</h3>
      <p className="text-sm text-[#8888AA] mb-4">{challenge.description}</p>
