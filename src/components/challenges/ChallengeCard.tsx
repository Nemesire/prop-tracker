...
export default function ChallengeCard({ challenge, userProgress }: Props) {
  ...
  return (
    <div className={`bg-surface border rounded-2xl p-5 transition-all ${completed ? 'border-[#22C55E]/40 bg-[#22C55E]/5' : 'border-border hover:border-[#7C3AED]/30'}`}>
      ...
      <h3 className="font-semibold text-text mb-1">{challenge.title}</h3>
