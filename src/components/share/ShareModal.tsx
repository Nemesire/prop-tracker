    ...
    <Modal open={open} onClose={onClose} title="Compartir resultados" size="lg">
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-[#F8F8FF]">PropTracker</span>
            </div>
            <p className="text-[#8888AA] text-xs mt-1">proptracker.community</p>
          </div>
          <div className="text-right">
            <div className="text-sm font-semibold text-[#F8F8FF]">{user.displayName}</div>
        ...
        <div className="mt-4 pt-4 border-t border-white/10 text-center">
          <p className="text-xs text-[#8888AA]">Únete a la comunidad de prop traders 🚀</p>
        </div>
      </div>
